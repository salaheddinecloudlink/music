    ...
    <div class="row">
        <div class="col-lg-2 col-md-12 col-sm-12 m-b-40">
            <div class="d-flex align-items-center justify-content-center">
                <div>
                    <img src="{{asset('external/images/logo.png')  }}" class="img-responsive home-logo" alt="">
                </div>
            </div>
...
<!-- /#wrapper -->
<!-- jQuery -->
<script src="{{ asset('external_fan/plugins/bower_components/jquery/dist/jquery.min.js') }}"></script>
<!-- Bootstrap Core JavaScript -->
<script src="{{ asset('external_fan/bootstrap/dist/js/tether.min.js') }}"></script>
<script src="{{ asset('external_fan/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('external_fan/plugins/bower_components/bootstrap-extension/js/bootstrap-extension.min.js') }}"></script>
<!-- Menu Plugin JavaScript -->
<script src="{{ asset('external_fan/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js') }}"></script>
<script src="{{ asset('external_fan/js/select2/dist/js/select2.full.min.js') }}"></script>
<!--slimscroll JavaScript -->
<script src="{{ asset('external_fan/js/jquery.slimscroll.js') }}"></script>
<!--Wave Effects -->
<script src="{{ asset('external_fan/js/waves.js') }}"></script>
<!-- Date Picker Plugin JavaScript -->
<script src="{{ asset('external_fan/plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
...
<script src="{{ asset('external_fan/js/custom.min.js') }}"></script>
