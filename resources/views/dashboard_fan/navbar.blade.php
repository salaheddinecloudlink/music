    ...
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg "
        ...
        <div class="top-left-part d-flex align-items-center justify-content-center">
            <a class="logo" href="./index.html">
                ...
                <span class="hidden-xs"><strong><img src="{{ asset('external_fan/plugins/images/logo.png') }}" class="nav-brand"
                            alt=""></strong></span>
            </a>
        </div>
        ...
        <div class="center-logo"
            ...
            <img src="external_fan/plugins/images/logo.png" alt="" width="200"></div>
