    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <div id="song-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form class="form-material form-horizontal">
                                    <div class="form-group">
                                        <label class="col-md-12" for="title">Song Title</label>
                                        <div class="col-md-12">
                                            <input type="text" value="The Spark of the Heat" id="title" name="title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            No
                                            <br>
                                            <input type="text" id="featureds" class="form-control" value="Sourcerer" />
                                        </div>
                                    </div>
